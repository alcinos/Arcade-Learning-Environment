...
later in this document. The first two options are disabled by default, while the third is
...
\section{C++ Agent: The Shared Library Interface} \label{sec:shared_library_interface}
...
\begin{center} \verb+sharedLibraryExample.cpp+\end{center}
