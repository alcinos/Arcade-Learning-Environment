...
altogether if the \verb+-restricted_action_set+ command--line argument is set to true. 
...
The screen is provided in row-order, i.e. beginning with the 160 pixels that compose the first row.
 ...
 If \verb+-send_rgb+ is set to true, the observation space consists of 100,928 
