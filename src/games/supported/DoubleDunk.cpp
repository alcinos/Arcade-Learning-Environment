...
ModeVect DoubleDunkSettings::getAvailableModes(){
    //this games has a menu that allows to define various yes/no options.
...
void DoubleDunkSettings::setMode(mode_t m,System &system, StellaEnvironment& environment){
    if(m>=0 && m<16){
        m_mode = m;
